...
scripts=(
  ...
  "$root/cli/status-ecosystem.sh"
  "$root/cli/status-mouse-dry-run.sh"
  "$root/cli/dsl-health.sh"
  "$root/dsl/run-smoke.sh"
  "$root/dsl/read-sensor-temp.sh"
  "$root/dsl/devices-usb.sh"
  "$root/control-layer/uri-dispatch.sh"
  "$root/control-layer/uri-shorthand-read.sh"
  "$root/control-layer/uri-decode-sensor.sh"
  "$root/control-layer/nlp-to-dsl.sh"
  "$root/control-layer/nlp-mouse-port.sh"
  "$root/control-layer/dsl-live-policy.sh"
  ...
  "$root/nlp2hillm/check-serial-env.sh"
  ...
  "$root/devices/input/mouse-status-live.sh"
  "$root/devices/sensor/temp-read-dry-run.sh"
  "$root/devices/sensor/temp-status-live.sh"
  "$root/devices/sensor/temp-resolve-address.sh"
)
